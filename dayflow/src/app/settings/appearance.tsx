      ...
      <ScreenScroll>
        <View style={{ gap: space.xl, paddingTop: space.sm }}>
          <View style={{ gap: space.sm }}>
            ...
            />
            <Caption tone="faint">
              Designed dark-first. The light theme keeps the same structure on a paper ground.
            </Caption>
          </View>
          ...
          <View>
            ...
            <View
              ...
              <Eyebrow color={accent.base}>Up next</Eyebrow>
              <MetricSmall tone="strong" style={{ fontSize: 26, lineHeight: 28 }}>
                Engineering Mathematics
              </MetricSmall>
              <View style={{ height: 5, backgroundColor: c.inset }}>
                <View style={{ width: '64%', height: 5, backgroundColor: accent.base }} />
              </View>
              <Body tone="muted" style={{ fontSize: 13 }}>
                Probability · 7:00 – 8:00 PM
              </Body>
            </View>
          </View>
        </View>
