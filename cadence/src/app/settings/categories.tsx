    ...
    <Screen>
              ...
              <View
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Caption tone="faint">
                    ...
                    {category.kind && category.kind !== 'general' ? ` · ${category.kind}` : ''}
                  </Caption>
                </View>
                <IconButton
                  icon="edit-3"
      ...
      <BottomSheet
        ...
        <View style={{ gap: space.lg, paddingBottom: space.base }}>
          <TextField label="Name" value={name} onChangeText={setName} placeholder="Side business" />
      ...
      <ConfirmationDialog
        ...
        message={
          deleting && deleting.usage.total > 0
            ? `${deleting.usage.tasks} task(s), ${deleting.usage.habits} habit(s) and ${deleting.usage.subjects} subject(s) use this category. Deleting it would leave them uncategorised.`
