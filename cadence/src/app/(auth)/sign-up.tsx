...
export default function SignUp() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      // Root layout routes into onboarding once the profile is created.
    } catch (error) {
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          <View style={{ gap: space.sm, paddingTop: space.lg }}>
            ...
            <Body tone="muted">Takes about a minute to set up.</Body>
          </View>
          ...
          <InlineNote
            icon="shield"
            text="Your data is stored under your own account and is only readable by you."
          />
